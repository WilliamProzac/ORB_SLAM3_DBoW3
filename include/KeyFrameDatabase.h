...
public:
  ...
  std::vector<std::shared_ptr<KeyFrame>> DetectLoopCandidates(
      std::shared_ptr<KeyFrame> pKF, float minScore);

  // Loop and Merge Detection
  void DetectCandidates(std::shared_ptr<KeyFrame> pKF, float minScore,
                        vector<std::shared_ptr<KeyFrame>> &vpLoopCand,
                        vector<std::shared_ptr<KeyFrame>> &vpMergeCand);
  void DetectBestCandidates(std::shared_ptr<KeyFrame> pKF,
                            vector<std::shared_ptr<KeyFrame>> &vpLoopCand,
                            vector<std::shared_ptr<KeyFrame>> &vpMergeCand,
                            int nMinWords);
  void DetectNBestCandidates(std::shared_ptr<KeyFrame> pKF,
                             vector<std::shared_ptr<KeyFrame>> &vpLoopCand,
                             vector<std::shared_ptr<KeyFrame>> &vpMergeCand,
                             int nNumCandidates);
