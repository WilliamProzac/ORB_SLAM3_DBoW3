...
public:
  ...
  typedef map<std::shared_ptr<KeyFrame>, g2o::Sim3, std::less<std::shared_ptr<KeyFrame>>,
              Eigen::aligned_allocator<std::pair<std::shared_ptr<KeyFrame> const, g2o::Sim3>>>
      KeyFrameAndPose;
...
public:
  ...
  void InsertSparsifiedKeyFrame(std::shared_ptr<KeyFrame> pKF);
...
protected:
  ...
  bool DetectAndReffineSim3FromLastKF(std::shared_ptr<KeyFrame> pCurrentKF,
  ...
  bool DetectCommonRegionsFromBoW(std::vector<std::shared_ptr<KeyFrame>> &vpBowCand,
                                  std::shared_ptr<KeyFrame> &pMatchedKF,
                                  std::shared_ptr<KeyFrame> &pLastCurrentKF, g2o::Sim3 &g2oScw,
                                  int &nNumCoincidences,
                                  std::vector<std::shared_ptr<MapPoint>> &vpMPs,
                                  std::vector<std::shared_ptr<MapPoint>> &vpMatchedMPs);
  bool DetectCommonRegionsFromLastKF(std::shared_ptr<KeyFrame> pCurrentKF, std::shared_ptr<KeyFrame> pMatchedKF,
                                     g2o::Sim3 &gScw, int &nNumProjMatches,
                                     std::vector<std::shared_ptr<MapPoint>> &vpMPs,
                                     std::vector<std::shared_ptr<MapPoint>> &vpMatchedMPs);
  int FindMatchesByProjection(std::shared_ptr<KeyFrame> pCurrentKF, std::shared_ptr<KeyFrame> pMatchedKFw,
                              g2o::Sim3 &g2oScw,
                              set<std::shared_ptr<MapPoint>> &spMatchedMPinOrigin,
  ...
  std::list<std::shared_ptr<KeyFrame>> mlpSparsifiedKeyFrameQueue;
